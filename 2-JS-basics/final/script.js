...
// var marcMass, marcHeight;
// marcMass = 90;
// marcHeight = 1.5;
// marcBmi = marcMass / (marcHeight * marcHeight);

// var marcIsFatterJohn = marcBmi > johnBmi;

// console.log("BMI John: " + johnBmi);
// console.log("BMI Mark: " + marcBmi);
// console.log("Is Mark's BMI higher than John's?" + " " + marcIsFatterJohn);
...
the bill when the bill is less than $50, 15% when the bill is between $50 and $200, and 10% if the bill is more
than $200.
...
// var restaurantBillSums = [124, 48, 268];
// var restaurantBillTips = [];
// var restaurantBillSumsWithTips = [];

// function calculateTip(billSum){
//     switch(billSum){
//         case billSum < 50:
//             return billSum / 100 * 20;
//         case billSum > 50 && billSum < 200:
//             return billSum / 100 * 15;
//         default:
//             return billSum / 100 * 10;
//     }
// }

// restaurantBillTips.push(restaurantBillSums[0]);
// restaurantBillTips.push(restaurantBillSums[1]);
// restaurantBillTips.push(restaurantBillSums[2]);

// restaurantBillSumsWithTips.push(restaurantBillSums[0] + restaurantBillTips[0]);
// restaurantBillSumsWithTips.push(restaurantBillSums[1] + restaurantBillTips[1]);
// restaurantBillSumsWithTips.push(restaurantBillSums[2] + restaurantBillTips[2]);

// console.log('Tips:');
// console.log(restaurantBillTips);
// console.log('Sums with tip:');
// console.log(restaurantBillSumsWithTips);
...
//     console.log(john.fullName + " is the fatty here with a BMI of: " + john.bmi);
// }else if(mark.bmi > john.bmi){
//     console.log(mark.fullName + " is the fatty here with a BMI of: " + mark.bmi);
// }else{
...
and in each iteration store the current sum in a variable (starting from 0). After you have the sum of the array, divide it by the number of elements in it (that's how you calculate the average)
